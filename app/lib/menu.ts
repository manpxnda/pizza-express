...
/** "Make it a meal" upsell shown inside the item builder for main dishes. */
export const MEAL_UPSELLS: MenuItem[] = [
  "2 Liter Pepsi",
  "Large Bread",
  "Cinnamon Sticks",
]
...
/** Categories that show the "Make it a meal" upsell. */
export const MEAL_UPSELL_CATS = [
  "pizzas",
  "specialty",
  "subs",
  "wings",
